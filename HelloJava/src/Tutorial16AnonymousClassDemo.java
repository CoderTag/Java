 ...
 * Usually you can not create object of interface. But if you use anonymous class you can create object of interface
 * SO if you don't want to reuse the class definition it is good to use anonymous class. 
 * Next Check Lambda Expression
 */
...
public class Tutorial16AnonymousClassDemo {
